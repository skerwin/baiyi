...
class AboutBaiYiController: BaseViewController {
...
//    setStringValueForKey(value: responseResult["about_url"].stringValue as String, key: "about_url")
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        urlString = stringForKey(key: "about_url") ?? "https://baiyi.lnyouran.com/web/about"
        self.title = "白医"
        loadWebView()
...
extension AboutBaiYiController: WKNavigationDelegate {
